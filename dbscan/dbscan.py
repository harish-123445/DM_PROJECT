...
with open('dbscan/dbscan_model.pkl', 'rb') as f:
    loaded_dbscan = pickle.load(f)

with open('dbscan/dbscan_model_scaler.pkl', 'rb') as f:
    loaded_scaler = pickle.load(f)

loaded_data = pd.read_pickle('dbscan/dbscan_model_clustered_movies.pkl')
